...
/* Server B source code: 1 UDP socket
...
#define MYPORT "22831"	// the port AWS will be connecting to
...
int main(void)
{
	...
	//main loop: 
	//Receive input from AWS, calculate and send the result back to AWS.
